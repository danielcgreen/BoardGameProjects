"""FoD_Dice.py Action Phase Assistant for GMT's Fields of Despair""" 

__author__ = "bobrosswins"
__credits__ = ["bobrosswins"]
__license__ = "GPL"
__version__ = "1.0"
__maintainer__ = "bobrosswins"
...
#Active Player results
	...
	if rolltype in (2,3) and fortress==2:
		print ('Note: First 6 reduces fortress, then blocks. After blocks destroyed, remaining 6(s) reduce fortress. Not considered destroyed until end of infantry combat.')
		print ()
